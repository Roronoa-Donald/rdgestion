        ...
        <div class="auth-header">
          <div class="logo-icon auth-logo">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img" aria-label="RDGESTION" width="36" height="36">
              <circle cx="256" cy="256" r="200" fill="var(--accent-color)"/>
              <circle cx="256" cy="256" r="170" fill="none" stroke="var(--accent-contrast)" stroke-width="3" stroke-opacity="0.15"/>
              <text x="256" y="256" text-anchor="middle" dominant-baseline="central" font-size="200" fill="var(--accent-contrast)" font-family="Rubik, Arial Black, sans-serif" font-weight="800" letter-spacing="-12">RD</text>
            </svg>
          </div>
          <h2>${title}</h2>
          <p>${subtitle}</p>
